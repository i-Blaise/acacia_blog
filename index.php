...
?>
  ...
  <div class="container">
    <iframe class="responsive-iframe" src="https://www.youtube.com/embed/2szVzrfmjyA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    <!-- <iframe class="responsive-iframe" src="<?php echo $row['blog_video'] ?>"></iframe> -->
  </div>
